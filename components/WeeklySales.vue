...
<template>
  <div
    class="block w-full p-3 mt-2 bg-white border border-gray-200 rounded-lg shadow-md"
  >
    <div
      class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-end mb-1"
    >
      <div>
        <button
    ...
    <div
      style="width: 70%"
      class="bg-gray-100 p-2 rounded-md text-center mx-auto"
    >
    ...
    >
      ...
      <tbody>
        ...
        >
          <th
            class="border-r px-4 py-2 font-medium text-gray-900 whitespace-nowrap"
          >
            {{ user.name }}
          </th>
          <td
            v-for="sale in user.weeklySales"
            class="border-r px-4 py-2 font-medium text-gray-900 whitespace-nowrap"
          >
            {{ sale }}
          </td>
    ...
    <div
      style="width: 70%"
      class="bg-gray-100 p-2 rounded-md mt-4 text-center border mx-auto"
    >
    ...
    >
      ...
      <tbody>
        <tr v-for="shift in shifts" class="bg-white border hover:bg-gray-50">
          ...
          <td
            v-for="sale in shift.weeklySales"
            class="border-r px-4 py-2 font-medium text-gray-900 whitespace-nowrap"
          >
            {{ sale }}
          </td>
