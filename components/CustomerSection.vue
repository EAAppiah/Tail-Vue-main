      ...
      <div class="p-6">
        ...
        >
          ...
          <div class="mb-4">
            ...
            <span>{{ customer.insuranceNumber }}</span>
          </div>
          <div class="mb-4">
            ...
            >
              ...
              <table class="min-w-full">
                ...
                <thead class="text-xs uppercase">
                  <tr>
                    <th class="px-4 py-2 border-b bg-gray-100 text-xs">Date</th>
      ...
      <div class="flex flex-col">
        ...
        >
          ...
          <table class="min-w-full">
            ...
            <thead class="text-xs uppercase">
              <tr>
                <th class="px-4 py-2 border-b bg-gray-100">Date</th>
                <th class="px-4 py-2 border-b bg-gray-100">Receipt</th>
                <th class="px-4 py-2 border-b bg-gray-100">Cost</th>
                <th class="px-4 py-2 border-b bg-gray-100">Disc%</th>
                <th class="px-4 py-2 border-b bg-gray-100">Amt Paid</th>
...
export default {
  ...
  computed: {
    totalCost() {
      return this.purchases.reduce(
        (total, purchase) =>
          total + (parseFloat(purchase.cost) - parseFloat(purchase.disc)),
        0
      );
    },
    totalPaid() {
      return this.purchases.reduce(
        (total, purchase) => total + parseFloat(purchase.amtPaid),
        0
      );
    },
    balance() {
    ...
    creditedAmountFromReceipt() {
      ...
      if (this.selectedPurchaseForReceipt) {
        return (
          this.selectedPurchaseForReceipt.cost -
          this.selectedPurchaseForReceipt.disc
        );
      }
      return 0;
    },
  ...
  methods: {
    ...
    calculateTotal(property, receiptDetails) {
      return receiptDetails.reduce(
        (total, detail) => total + parseFloat(detail[property]),
        0
      );
    },
