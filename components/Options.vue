...
<template>
  <div data-dial-init class="absolute end-6 bottom-6 group">
    <div 
      id="speed-dial-menu-bottom-right" 
      class="absolute flex flex-col items-center hidden mb-4 space-y-2"
      >
      <button 
        type="button" 
      ...
      <div 
        id="tooltip-share" 
        role="tooltip"
        class="absolute z-20 invisible inline-block w-auto px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700"
        >
        Share
      ...
      <button 
        ...
        data-tooltip-placement="left"
        class="absolute z-10 flex justify-center items-center w-[52px] h-[52px] text-gray-500 hover:text-gray-900 bg-white rounded-full border border-gray-200 dark:border-gray-600 shadow-sm dark:hover:text-white dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 focus:outline-none dark:focus:ring-gray-400"
        >
        <svg 
          class="w-5 h-5" 
          aria-hidden="true" 
